...
#
# Erzeuge ein Sinussignal und quantisiere es auf eine bestimmte Anzahl von
...
AQ[f_a * T_mess] = abs(AQ[f_a * T_mess] - A[f_a * T_mess]) # Subtrahiere Signal
S = 10*log10(A[f_a * T_mess]**2.)       # Signalleistung, gemessen 
